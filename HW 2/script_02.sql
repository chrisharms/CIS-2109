/* script name: LOAD1BIGPV_MDM_12E.SQL                   */
...
INSERT INTO EmployeeSkills_T  (EmployeeID, SkillID, QualifyDate)
VALUES  ('Laura', 'UC1', '22-FEB-10');
INSERT INTO EmployeeSkills_T  (EmployeeID, SkillID, QualifyDate)
VALUES  ('Laura', 'US1', '22-FEB-10');
INSERT INTO EmployeeSkills_T  (EmployeeID, SkillID, QualifyDate)
VALUES  ('Laura', 'UT1', '22-FEB-10');
...
VALUES (1, 1, to_date('16/Sep/15 ', 'DD/MON/YY'));

INSERT INTO Shipped_T (OrderLineID, ShippedQuantity, ShippedDate) 
VALUES (2, 0, to_date('', 'DD/MON/YY'));

INSERT INTO Shipped_T (OrderLineID, ShippedQuantity, ShippedDate) 
VALUES (3, 1, to_date('16/Sep/15 ', 'DD/MON/YY'));

INSERT INTO Shipped_T (OrderLineID, ShippedQuantity, ShippedDate) 
VALUES (5, 2, to_date('16/Sep/15', 'DD/MON/YY'));
...
VALUES (1, 1, to_date('01/Mar/15', 'DD/MON/YY'), 'D', 1000.0, 'chk101');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (2, 24, to_date('10/Mar/15', 'DD/MON/YY'), 'D', 25.0, 'cash');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (3, 26, to_date('10/Mar/15', 'DD/MON/YY'), 'D', 222.0, 'cash');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (4, 28, to_date('10/Mar/15', 'DD/MON/YY'), 'D', 25.0, 'cash');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (5, 32, to_date('11/Mar/15', 'DD/MON/YY'), 'D', 3000.0, 'Cashiers Check');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (6, 34, to_date('11/Mar/15', 'DD/MON/YY'), 'D', 575.0, 'Chk1201');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (7, 39, to_date('11/Mar/15', 'DD/MON/YY'), 'D', 600.0, 'chk 1003');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (8, 48, to_date('11/Mar/15', 'DD/MON/YY'), 'D', 1000.0, 'chk2301');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (9, 51, to_date('11/Mar/15', 'DD/MON/YY'), 'D', 150.0, 'cash');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (10, 54, to_date('11/Mar/15', 'DD/MON/YY'), 'D', 2650.0, 'Check # 343');

INSERT INTO Payment_T (PaymentID, OrderID, PaymentDate, PaymentTypeID, PaymentAmount, PaymentComment) 
VALUES (11, 69, to_date('11/Mar/15', 'DD/MON/YY'), 'D', 200.0, 'chk3001');
